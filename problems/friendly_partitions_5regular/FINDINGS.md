...
Total across n≥20: well over **36.5 million** random samples, zero
exceptions found anywhere. The clean run now extends unbroken and
densely-sampled (6,000-120,000 independent draws per even n, no gaps)
...
800, 850, 900, 950, **1000** — a full order of magnitude past where the
run began pushing the frontier.
