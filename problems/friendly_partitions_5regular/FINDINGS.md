...
Total across n≥20: well over **37.5 million** random samples, zero
...
800, 850, 900, 950, 1000, 1100, 1200 — a full order of magnitude past
where the run began pushing the frontier.
