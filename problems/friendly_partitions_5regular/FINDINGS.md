...
Total across n≥20: well over **38 million** random samples, zero
exceptions found anywhere. The clean run now extends unbroken and
densely-sampled (5,000-120,000 independent draws per even n, no gaps)
...
800, 850, 900, 950, 1000, 1100, 1200, 1300 — a full order of magnitude
past where the run began pushing the frontier.
